...
foreach($cast as $c) {
	...
	$castTableRows .= "
		<tr data-person-id='$c->id' data-person-name='$c->firstName $c->lastName' data-age='" . getAge($c->dateOfBirth) . "'>
			...
			<td>" . ($c->role ? "<b>{$c->role}</b>" . ($groups ? ", $groups" : "") : $groups) . "</td>
		</tr>";
}
...
<body id='<?=$thisPageBaseName;?>'>
	<?=$topper;?>
		...
		<section class='main'>
			...
			<p>If you were cast in the show, congratulations!  We are excited to get to know each and every one of you and work together on this great show!<!--   Please make special note of our mandatory first cast/parent meeting on November 22nd (<a href='cast_info.php'>click here for details</a>). --></p>
			...
			<p>* Denotes a role that will be performed on Dec 31st Evening, Jan 2nd Evening, and Jan 3rd Matinee.<br>
				** Denotes a role that will be performed on Jan 1st Matinee, Jan 1st Evening, and Jan 3rd Evening.</p>
