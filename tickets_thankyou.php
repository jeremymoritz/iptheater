...
$pageContent = "
	...
	<p><strong>Purchased:</strong> " . $tixCount . " Ticket" . ($tixCount > 1 ? "s" : "") . " to {$currentShow->getTitle()} at {$currentShow->getPerformance(apiSession('performanceId'))->getDateTimeFormatted()} at The Goppert Theater at Avila University (11901 Wornall Rd, Kansas City, MO 64145)</p>
