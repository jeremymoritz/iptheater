...
if(apiPost('submit') && !$likelySpam) {
	...
	$message = "<b>13 Wait List Entry:</b><br><br>\n"
		...
		. "<b>date:</b> $date<br>\n"
		. "<b>ip:</b> $ip<br>\n";
	$subject = "13 Wait List: $firstName $lastName";
	...
	$message = "<p>Hi $firstName!<br><br>\n"
		. "We want to let you know that you are now on the official wait list for Immeasurable Productions' Summer Camp: 13. "
	...
	$subject = "You are on the Wait List for 13!";
